...
export function loadConfig(configPath: string = 'config.toml'): BotConfig {
  ...
  return {
    ...
    trading: {
      ...
      defaultDipThreshold: raw.trading.default_dip_threshold ?? 0.15,
      windowMinutes: raw.trading.window_minutes ?? 12,
      maxCycles: raw.trading.max_cycles ?? 1,
      dumpWindowMs: raw.trading.dump_window_ms ?? 10000,
      ...
      gtcFillTimeoutMs: raw.trading.gtc_fill_timeout_ms ?? 90000,
